...
const Outline = React.memo<Pick<ISaxIconProps, 'color'>>(({ color }) => <>
  <path d="M10 22.75H9c-5.43 0-7.75-2.32-7.75-7.75V9c0-5.43 2.32-7.75 7.75-7.75h6c5.43 0 7.75 2.32 7.75 7.75v2c0 .41-.34.75-.75.75s-.75-.34-.75-.75V9c0-4.61-1.64-6.25-6.25-6.25H9C4.39 2.75 2.75 4.39 2.75 9v6c0 4.61 1.64 6.25 6.25 6.25h1c.41 0 .75.34.75.75s-.34.75-.75.75Z" fill={color}></path><path d="M22.001 9.25H2.031c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h19.97c.41 0 .75.34.75.75s-.34.75-.75.75ZM12.001 16.25h-9.97c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h9.97c.41 0 .75.34.75.75s-.34.75-.75.75Z" fill={color}></path><path d="M8.51 22.74c-.41 0-.75-.34-.75-.75V2.02c0-.41.34-.75.75-.75s.75.34.75.75v19.97c0 .41-.33.75-.75.75ZM15.51 12.74c-.41 0-.75-.34-.75-.75V2.02c0-.41.34-.75.75-.75s.75.34.75.75v9.97c0 .41-.33.75-.75.75ZM14.761 22.748c-.42 0-.8-.15-1.08-.43-.34-.33-.49-.82-.41-1.33l.23-1.59c.05-.38.28-.84.56-1.12l4.15-4.15c.54-.54 1.07-.82 1.63-.88.69-.07 1.38.23 2.03.88.65.65.95 1.33.88 2.03-.05.56-.34 1.09-.88 1.63l-4.15 4.15c-.27.27-.73.5-1.12.56l-1.58.23c-.09.01-.18.02-.26.02Zm5.26-8h-.04c-.2.02-.44.17-.72.45l-4.15 4.15c-.05.05-.12.2-.13.27l-.23 1.59 1.63-.18c.07-.01.22-.09.27-.13l4.15-4.15c.28-.28.43-.52.45-.72.02-.23-.13-.5-.45-.82-.3-.31-.56-.46-.78-.46Z" fill={color}></path><path d="M20.74 18.61c-.07 0-.13-.01-.2-.03-1.5-.42-2.7-1.62-3.12-3.12-.11-.4.12-.81.52-.92.41-.11.81.12.92.52.28 1 1.08 1.8 2.08 2.08a.749.749 0 0 1-.2 1.47Z" fill={color}></path>
</>)

const TwoTone = React.memo<Pick<ISaxIconProps, 'color'>>(({ color }) => <>
  <path d="M22 11V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7h1" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><g opacity=".4" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M2.03 8.5H22M2.03 15.5H12M8.51 21.988V2.008M15.51 11.988v-9.98"></path></g><path d="m18.73 14.671-4.15 4.15c-.16.16-.31.47-.35.69l-.23 1.59c-.08.57.32.98.89.89l1.59-.23c.22-.03.53-.19.69-.35l4.15-4.15c.71-.71 1.05-1.55 0-2.6-1.04-1.04-1.87-.71-2.59.01Z" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path><path d="M18.14 15.262a3.761 3.761 0 0 0 2.6 2.6" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
</>)
...
export const GridEdit = forwardRef<SVGSVGElement, ISaxIconProps>((props, ref) => {
  const {
    variant = "Outline",
    color = "inherit",
    size = 14,
